...
namespace pfaedle::osm
{
    ...
    std::optional<trgraph::station_info>
    osm_reader::get_station_info(trgraph::node *node, osmid nid, const POINT &pos, const attribute_map &m,
    ...
    std::string
    osm_reader::get_attribute_by_first_match(const deep_attribute_list &rule, osmid id, const attribute_map &attrs,
                                             const relation_map &entRels, const relation_list &rels,
    ...
    osm_reader::get_matching_attributes_ranked(const deep_attribute_list &rule, osmid id, const attribute_map &attrs,
                                               const relation_map &entRels, const relation_list &rels,
    ...
    std::vector<trgraph::transit_edge_line *>
    osm_reader::get_lines(const std::vector<size_t> &edgeRels, const relation_list &rels, const osm_read_options &ops)
    {
